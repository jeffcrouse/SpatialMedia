...
### Oveview
This set of examples illustrates how to take data from the Internet and funnel it into a Spacebrew Publisher. In terms of Spatial Media, we could consider a Publsiher to be in Input that can be connected to a yet-to-be-determined Output.  This particular set is focused on continual, "real-time" data streams for reasons that will be explained in class.

This can be a super broad subject since the web encompasses so many different methods of communication, but here we will focus on just a few, and hopefully you will see something that interests you. 
...
Communicating with the web can be advantageous in Spatial Media for a variety of reasons:
